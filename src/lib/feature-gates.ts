...
export function getUnavailableReason(
  ...
  return `${getFeatureLabel(feature)} requires the enhanced Hermes gateway (outsourc-e/vorbium-agent). Vanilla hermes-agent runs in portable mode without ${getFeatureLabel(feature).toLowerCase()}.`
}
