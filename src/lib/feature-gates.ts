...
export function getUnavailableReason(
  ...
  return `${getFeatureLabel(feature)} requires the enhanced Vorbium gateway (outsourc-e/vorbium-agent). Vanilla hermes-agent runs in portable mode without ${getFeatureLabel(feature).toLowerCase()}.`
}
