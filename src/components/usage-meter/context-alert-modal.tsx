...
function ContextAlertModalComponent({
  ...
  // 35% is an early warning — Vorbium auto-compacts at ~40%
            ...
            <p className="text-xs text-primary-600 leading-relaxed">
              {isCritical
                ...
                : isDanger
                  ...
                  : 'Vorbium will auto-compact your context soon (it triggers at ~40% usage). Older messages will be summarized. Consider writing a handoff or starting a new chat to preserve full context.'}
            </p>
          </div>
