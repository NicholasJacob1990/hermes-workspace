...
function BrailleSpinnerComponent({
  ...
  const frames = PRESETS[preset] ?? PRESETS.vorbium
...
// Usage:
// <BrailleSpinner />                          — default vorbium animation
// <BrailleSpinner preset="braille" />          — classic rotating
// <BrailleSpinner preset="orbit" size={24} />  — orbiting dot, 24px
// <BrailleSpinner preset="vorbium" color="var(--color-primary-500)" speed={120} />
