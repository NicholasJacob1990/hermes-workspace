...
export const tourSteps: Array<Step> = [
  // Step 1: Welcome
  {
    target: 'body',
    placement: 'center',
    title: 'Welcome to Vorbium Engine! ⚕',
    content: (
      <div
        style={{
          display: 'flex',
  ...
  // Step 8: Terminal
  {
    ...
    content:
      'Built-in terminal for quick commands. Execute shell commands without leaving Vorbium Engine.',
  },
  ...
  // Step 10: Settings
  {
    ...
    content:
      'Configure providers, themes, accent colors, and more. Make Vorbium Engine yours.',
  },
  // Step 11: Finish
  {
    target: 'body',
    ...
    content:
      'Start chatting with your AI, explore the tools, and customize Vorbium Engine to fit your workflow. Need help? Press ? to see all keyboard shortcuts.',
  },
]
