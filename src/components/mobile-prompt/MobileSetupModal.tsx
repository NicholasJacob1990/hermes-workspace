  ...
  const steps = [
    {
      ...
      body: 'Install Tailscale on the machine running Vorbium Engine, then sign in.',
    ...
    },
    {
      ...
      body: 'Vorbium Engine can talk to any OpenAI-compatible backend on mobile too. Make sure both the workspace and backend stay reachable over Tailscale or your local network.',
      ...
      action: (
        <div className="rounded-lg border border-primary-700 bg-primary-950 px-4 py-3 text-sm text-primary-200">
          Enhanced Vorbium gateway APIs are optional. If core chat already works
    ...
    {
      title: 'Open Vorbium Engine on your phone',
      body:
