# Contributing to Vorbium Engine Workspace
...
3. Set up environment:
   ...
   ```
4. Start [Vorbium Engine](https://github.com/NousResearch/hermes-agent) API server
...
- `HERMES_API_URL` — Vorbium Engine gateway backend (default: `http://127.0.0.1:8642`)
